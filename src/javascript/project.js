...
// load our modules
//require('../modules/my-module/script');
...
Styleguide.templates = require('./client.tpl');

},{"./client.tpl":4}],2:[function(require,module,exports){
'use strict';
...
templatizer["button"]["button"] = function tmpl_button_button(data) {
    ...
    var modifiers = data.modifiers || [];
    {
        ...
        }, attributes ]), false) + '><span class="button-text">' + jade.escape(null == (jade_interp = data.text) ? "" : jade_interp) + "</span></a>");
    }
    return buf.join("");
};
